...
<div class="container">
    <div class="recipe-header" style="text-align: center; margin-bottom: 30px;">
        ...
        <form action="{{ route('tambah_riwayat', $resep->id_resep) }}" method="POST">
            @csrf
    ...
    <div class="ingredient-card">
        <div class="recipe-body">
            <table style="width: 100%;">
                <thead>
                    <tr>
                        <th style="font-size: 20px; color: #333; border-bottom: 2px solid #ccc; padding-bottom: 10px; text-align: center">Nama Bahan</th>
                        <th style="font-size: 20px; color: #333; border-bottom: 2px solid #ccc; padding-bottom: 10px; text-align: center">Takaran</th>
                        <th style="font-size: 20px; color: #333; border-bottom: 2px solid #ccc; padding-bottom: 10px; text-align: center">Satuan</th>
                    </tr>
                </thead>
                <tbody>
                    @foreach ($bahan as $bahan)
                        <tr>
                            <td style="font-size: 18px; color: #555; border-bottom: 1px solid #ccc; padding: 8px; text-align: center">{{ $bahan->nama_bahan }}</td>
                            <td style="font-size: 18px; color: #555; border-bottom: 1px solid #ccc; padding: 8px; text-align: center">{{ $bahan->takaran }}</td>
                            <td style="font-size: 18px; color: #555; border-bottom: 1px solid #ccc; padding: 8px; text-align: center">{{ $bahan->satuan }}</td>
                        </tr>
                    @endforeach
                </tbody>
            </table>
